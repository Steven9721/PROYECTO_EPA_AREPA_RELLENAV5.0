...
function addToCart(productId) {
    ...
    document.getElementById('payButton')?.addEventListener('click', () => {
        window.location.href = '../Vista_Cliente/carrito.html';
    });
}
...
var modal = document.getElementById("ultimoAntojoModal"); // Modal
var carritoBtn = document.getElementById("carritoBtn");   // Botón del carrito
var closeModal = document.getElementsByClassName("close")[0]; // Botón cerrar (X)
var noPorAhoraBtn = document.getElementById("noPorAhoraBtn"); // Botón "No por ahora"

// Mostrar el modal cuando se haga clic en el botón del carrito
...
closeModal.onclick = function() {
  ...
  window.location.href = "../vista_cliente/carrito2.html"; // Redirigir al carrito
}

// Cerrar el modal cuando se haga clic en el botón "No por ahora"
noPorAhoraBtn.onclick = function() {
  modal.style.display = "none"; // Ocultar el modal
  window.location.href = "../vista_cliente/carrito2.html"; // Redirigir al carrito
}
